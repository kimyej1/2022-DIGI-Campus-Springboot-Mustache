...
public class PostApiControllerTest {
    @LocalServerPort
    private int port;   // 단위테스트용 port#(자동)
    ...
    @AfterEach  // 단테 하나 끝날때마다 clean up 해줘
    ...
    public void postsRegistTest() throws Exception
    {
        ...
        assertThat(responseEntity.getBody()).isGreaterThan(0L); // Long type 0
        /*
            float degree = 1.23F;
            long valus = 123L;
         */
